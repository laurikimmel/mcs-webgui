...
dojo.declare("ParameterController", webgui.pac.Controller, {
    ...
    constructor: function(args) {
        ...
        var presentation = new webgui.pac.ListPresentation({
                    ...
                    dndTypes: [webgui.common.Constants.DND_TYPE_PARAMETER],
                    selectionTopic: webgui.common.Constants.TOPIC_SELECTION_PARAMETER,
                });
...
dojo.declare("webgui.display.ParameterDisplay", null, {
    constructor: function(args) {
        console.log("[ParameterDisplay] initializing components ...");
